...
const ChatBot = () => {
  ...
  const handleBotResponse = (input: string) => {
    ...
    const response =
      faqData.find((faq) => input.includes(faq.question))?.answer ||
    ...
    <section className="bg-gray-50 py-12 px-4 md:px-12 lg:px-4">
          ...
          <div className="p-4">
            <div className="flex items-center space-x-4">
              ...
              <Button
                ...
                // className="bg-guelphBlack hover:bg-blue-600 text-blue rounded-lg font-bold py-2 px-8 border-blue"
              >
                Send
              </Button>
            </div>
      ...
      >
        ...
        <div className="flex flex-wrap gap-4">
          ...
          >
            <ul>
              <li>What are simulation assignments and their deadlines?</li>
              <li>How are Excel assignments submitted?</li>
              <li>When are the quizzes scheduled?</li>
              <li>What is the format of the final exam?</li>
              <li>Guidelines for discussion posts?</li>
              <li>How to contact the instructor?</li>
              <li>What is the required textbook?</li>
              <li>What are MyLab assignments?</li>
            </ul>
          </div>
        </div>
      </div>
